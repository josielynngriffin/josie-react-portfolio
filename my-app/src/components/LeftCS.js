...
function LeftCS({header, subtitle, textContent, imgLabel, img, imgAlt, imgDescription}) {
    const paragraphs = textContent.split('\n');

    return (
        <div className="projectIntroCS__wrapper leftCS__wrapper case-study__component--margin">
