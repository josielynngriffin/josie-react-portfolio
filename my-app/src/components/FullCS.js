...
function FullCS({header, subtitle, textContent, listContent, imgLabel, img, imgAlt, imgDescription, className = ""}) {
    ...
    return (
        <div className={`CS-component__wrapper case-study__padding fullCS__wrapper ${className}`}>
            ...
            <section className="fullCS--image-wrap">
                ...
                <img  className="fullCS--image case-study-image__radius" src={img} alt={imgAlt}></img>
